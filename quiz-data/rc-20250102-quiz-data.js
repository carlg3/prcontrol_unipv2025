...
const quizData = [
  ...
  {
    id: 2,
    question: "Given a 3 axes planar anthropomorphic robot manipulator in the plane [x,y] with links of equal lengths l, then the inverse kinematics problems has a nonsingular solution if the required position for the origin of the tool reference frame (placed at the end of the third link) is at point $\\underline{p}=[p_{x},p_{y}]^{T}$ with $||p||=3l$",
    type: "single-choice",
    options: [
      { text: "True" },
      { text: "False" }
  ...
  {
    id: 5,
    question: "Given the robot in the picture and its specifications (2230 mm), select the correct claims:",
    type: "multiple-choice",
    image: "./img/RC/HW2/5.png",
    options: [
  ...
  },
  {
    ...
    correctAnswer: ["$q_{1}=\\frac{\\pi}{4}$ $q_{2}=\\frac{\\pi}{12}$"],
    points: 1
  },
  {
    id: 8,
