...
const quizData = [
            ...
            {
                id: 7,
                question: "Given the process described by the transfer function G(s) = 1 / ((s+10)(s+30)), assuming to control it by means of the control scheme: [...] where the inner controller Ri(s) = k and k is selected using the root locus approach, the following claims are true:",
                type: "multiple-choice",
                image: "./img/7.jpg",
                options: [
            ...
            {
                id: 11,
                question: "The system described by the following mathematical expression: e^(-2s) / (s+1)^2 is nonlinear",
                type: "single-choice",
                options: [
                    { text: "Vero" },
                    { text: "Falso" }
            ...
            {
                id: 12,
                question: "The process described by the transfer function G(s) = (s + 10^2) / (10s(s + 10)) is nonlinear and has gain equal to 1.",
                type: "single-choice",
                options: [
                    { text: "Vero" },
                    { text: "Falso" }
            ...
            {
                id: 20,
                question: "To reject a measurable process disturbance, in case of LTI systems, the only possibility is to use a compensator M(s) = -H(s)/G(s) (H and G defined in the course).",
                type: "single-choice",
                options: [
                    { text: "Vero" },
                    { text: "Falso" }
